...
with app.app_context():
    ...
    country1 = Country(name='Egypt', coach='Coach 1', star_rating=4, flag_url='https://cdn.britannica.com/85/185-004-1EA59040/Flag-Egypt.jpg', group_stage=group_stage1)
    country2 = Country(name='Cameron', coach='Coach 2', star_rating=3, flag_url='https://cdn.britannica.com/42/5042-050-CE5D885F/Flag-Cameroon.jpg?w=400&h=235&c=crop', group_stage=group_stage1)
    country3 = Country(name='Algeria', coach='Coach 3', star_rating=5, flag_url='https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Flag_of_Algeria.svg/2560px-Flag_of_Algeria.svg.png', group_stage=group_stage2)
    country4 = Country(name='Kenya', coach='Coach 4', star_rating=3, flag_url='https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Flag_of_Kenya.svg/800px-Flag_of_Kenya.svg.png?20221128225827', group_stage=group_stage2)
