        ...
        <div className="flex justify-between">
            ...
            <section className="flex-1 flex justify-center">
                <form className=" w-[73%] mt-0">
                    <h1 className="font-medium text-4xl mt-4">Sign Up</h1>
                    <div className="mt-8">
                  ...
                  <button type='submit' className="mt-4 mb-5 bg-blue-500 hover:bg-blue-600 py-3 px-7 rounded-3xl text-white text-sm uppercase">Sign Up</button>
