const PlayerCard = ({eachPlayer,theCountry}) => {
  ...
  return (
    <div className="font-poppins cursor-pointer ">
        <div className="player-card relative border-[1px] border-[rgba(0,0,0,0.4)] bg-white h-[26rem] w-[21rem] rounded-bl-[4rem] rounded-br-[4rem] rounded-lg hover:shadow-[0_0_7px_rgba(0,0,0,0.2)]">
